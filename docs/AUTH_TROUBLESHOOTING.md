...
#### 1. initData отсутствует или пустой
...
- Проверьте, что Mini App URL настроен в @BotFather
- Убедитесь, что используется правильный домен (app.amesin.ru)
